...
<head>
  ...
  <link rel=stylesheet href="${ctx}/jQueryGantt/platform.css" type="text/css">
  <link rel=stylesheet href="${ctx}/jQueryGantt/libs/jquery/dateField/jquery.dateField.css" type="text/css">
 ...
 <!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
  ...
  <script src="${ctx}/jQueryGantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
  <script src="${ctx}/jQueryGantt/libs/jquery/jquery.timers.js"></script>

  <script src="${ctx}/jQueryGantt/libs/utilities.js"></script>
  <script src="${ctx}/jQueryGantt/libs/forms.js"></script>
  <script src="${ctx}/jQueryGantt/libs/date.js"></script>
  <script src="${ctx}/jQueryGantt/libs/dialogs.js"></script>
  <script src="${ctx}/jQueryGantt/libs/layout.js"></script>
  <script src="${ctx}/jQueryGantt/libs/i18nJs.js"></script>
  <script src="${ctx}/jQueryGantt/libs/jquery/dateField/jquery.dateField.js"></script>
  <script src="${ctx}/jQueryGantt/libs/jquery/JST/jquery.JST.js"></script>

  <script type="text/javascript" src="${ctx}/jQueryGantt/libs/jquery/svg/jquery.svg.min.js"></script>
  <script type="text/javascript" src="${ctx}/jQueryGantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


  <script src="${ctx}/jQueryGantt/ganttUtilities.js"></script>
  <script src="${ctx}/jQueryGantt/ganttTask.js"></script>
  <script src="${ctx}/jQueryGantt/ganttDrawerSVG.js"></script>
  <script src="${ctx}/jQueryGantt/ganttGridEditor.js"></script>
  <script src="${ctx}/jQueryGantt/ganttMaster.js"></script>  
</head>
...
function loadFromLocalStorage() {
 ...
 // var data = new Object(); var json_data = JSON.stringify(data);
  ...
  if (!ret || !ret.tasks || ret.tasks.length == 0){
	  var JSONStr2 ={"id": 2, "name": "222222222","start": 1396994400000, "duration": 10};
	   //alert(JSONStr1);
    ...
    ret= {"tasks": 
    	       ...
    	       [
    	        {"id": 1, "name": "Gantt editor11", "progress": 0, "progressByWorklog": false, "relevance": 0, "type": "", "typeId": "", "description": "", "code": "", "level": 0, "status": "STATUS_ACTIVE", "depends": "", "canWrite": true, "start": 1396994400000, "duration": 20, "end": 1399586399999, "startIsMilestone": false, "endIsMilestone": false, "collapsed": false, "assigs": [], "hasChild": true},
    	       JSONStr2,    	    
...
<div class="__template__" type="GANTBUTTONS">
  <div class="ganttButtonBar noprint">
    <div class="buttons">
      ...
      <button onclick="$('#workSpace').trigger('redo.gantt');return false;" class="button textual icon requireCanWrite" title="还原"><span class="teamworkIcon">&middot;</span></button>
    ...
    <span class="ganttButtonSeparator"></span>
      <button onclick="print();return false;" class="button textual icon " title="打印"><span class="teamworkIcon">p</span></button>
    <span class="ganttButtonSeparator"></span>
    ...
    <button onclick="editResources();" class="button textual requireWrite" title="编辑负责人"><span class="teamworkIcon">M</span></button>
      &nbsp; &nbsp; &nbsp; &nbsp;
    <button onclick="saveGanttOnServer();" class="button first big requireWrite" title="保存">保存</button>
    <button onclick='newProject();' class='button requireWrite newproject'><em>清空</em></button>
    <button class="button login" title="login/enroll" onclick="loginEnroll($(this));" style="display:none;">登入</button>
...
<div class="__template__" type="TASKSEDITHEAD"><!--
  <table class="gdfTable" cellspacing="0" cellpadding="0">
    ...
    <tr style="height:40px">
      ...
      <th class="gdfColHeader gdfResizable" style="width:100px;">任务编码-thead</th>
...
<div class="__template__" type="TASKROW"><!--
  <tr taskId="(#=obj.id#)" class="taskEditRow (#=obj.isParent()?'isParent':''#) (#=obj.collapsed?'collapsed':''#)" level="(#=level#)">
    ...
    <td class="gdfCell"><input type="text" name="code" value="(#=obj.code?obj.code:''#)" placeholder="任务编码_TASKROW"></td>
    <td class="gdfCell indentCell" style="padding-left:(#=obj.level*10+18#)px;">
      <div class="exp-controller" align="center"></div>
      <input type="text" name="任务名称" value="(#=obj.name#)" placeholder="name">
    </td>
  ...
  <div class="ganttTaskEditor">
    ...
    <table  cellspacing="1" cellpadding="5" width="100%" class="taskData table" border="0">
        ...
        <td width="200" style="height: 80px"  valign="top">
          <label for="code">任务编码_TASK_EDITOR</label><br>
      ...
      <tr>
        <td  colspan="2">
          ...
          <select id="status" name="status" class="taskStatus" status="(#=obj.status#)"  onchange="$(this).attr('STATUS',$(this).val());">
            <option value="STATUS_ACTIVE" class="taskStatus" status="STATUS_ACTIVE" >活动</option>
