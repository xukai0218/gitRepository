...
<meta name="description" content="">
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="${ctx}/assets/login-background/css/reset.css">
        <link rel="stylesheet" href="${ctx}/assets/login-background/css/supersized.css">
        <link rel="stylesheet" href="${ctx}/assets/login-background/css/style.css">
